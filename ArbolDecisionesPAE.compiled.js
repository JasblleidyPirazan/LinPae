...
const CONDITION_MAPPINGS = {
  ...
  'zona rural': {
    variable: 'zona',
    matches: ['Rural', 'Rural de difícil acceso']
  },
  'rural de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'zona rural de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'zona rural de dificil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'rural_dificil_acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  ...
  'zona = rural_dificil_acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'sedes en zonas rurales de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'sede educativa = ubicada en zona rural de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'sede educativa = zona rural de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  'sede = zona rural de difícil acceso': {
    variable: 'zona',
    matches: ['Rural de difícil acceso']
  },
  // --- Modalidad ---
  'industrializada': {
    variable: 'modalidad',
    matches: ['Industrializada']
  },
  'modalidad = industrializada': {
    variable: 'modalidad',
    matches: ['Industrializada']
  },
  'modalidad_actual = industrializada': {
    variable: 'modalidad',
    matches: ['Industrializada']
  },
  'preparada_en_sitio': {
    variable: 'modalidad',
    matches: ['Preparada en sitio']
  },
  'modalidad = preparada_en_sitio': {
    variable: 'modalidad',
    matches: ['Preparada en sitio']
  },
  'preparada en sitio': {
  ...
  'caliente_transportada': {
    variable: 'modalidad',
    matches: ['Caliente transportada']
  },
  'modalidad = caliente_transportada': {
    variable: 'modalidad',
    matches: ['Caliente transportada']
  },
  ...
  // --- Tipo ETC ---
  'etc sea departamental con operación descentralizada': {
    variable: 'tipoETC',
    matches: ['Departamental']
  },
  'etc departamental con operación descentralizada': {
    variable: 'tipoETC',
    matches: ['Departamental']
  },
  'tipo_ETC = departamental': {
    variable: 'tipoETC',
    matches: ['Departamental']
  },
  'ETC departamental': {
  ...
  // --- Nivel escolar ---
  'nivel_escolar = segundo_ciclo_educacion_inicial': {
    variable: 'nivelEscolar',
    matches: ['Preescolar / 2do ciclo ed. inicial']
  },
  'nivel = segundo_ciclo_educacion_inicial': {
    variable: 'nivelEscolar',
    matches: ['Preescolar / 2do ciclo ed. inicial']
  },
  'segundo_ciclo_educacion_inicial': {
    variable: 'nivelEscolar',
    matches: ['Preescolar / 2do ciclo ed. inicial']
  },
  ...
  'jornada = 8h': {
    variable: 'jornada',
    matches: ['Extendida (8h)']
  },
  'jornada >= 6h': {
    variable: 'jornada',
    matches: ['Completa (6h)', 'Extendida (8h)', 'Jornada única']
  },
  // --- Enfoque diferencial (población) ---
  'indigena': {
    variable: 'enfoqueDif',
    matches: ['Indígena']
  },
  ...
  // --- Modelo de atención (operativo) ---
  'modelo diferencial indígena': {
    variable: 'modeloAtencion',
    matches: ['Pueblos indígenas']
  },
  'modelo_indigena': {
    variable: 'modeloAtencion',
    matches: ['Pueblos indígenas']
  ...
  'poblacion_mayoritariamente_indigena': {
    variable: 'modeloAtencion',
    matches: ['Pueblos indígenas']
  },
  'modelo_NARP': {
    variable: 'modeloAtencion',
    matches: ['Comunidades NARP']
  },
  'modelo_narp': {
    variable: 'modeloAtencion',
    matches: ['Comunidades NARP']
  ...
  'receso_estudiantil': {
    variable: 'situacion',
    matches: ['Receso estudiantil']
  },
  'periodo = receso_estudiantil': {
    variable: 'situacion',
    matches: ['Receso estudiantil']
  },
  'receso estudiantil': {
  ...
  'grave_perturbacion_orden_publico': {
    variable: 'situacion',
    matches: ['Emergencia declarada']
  },
  // --- Financiación ---
  'recursos SGR': {
    variable: 'financiacion',
    matches: ['SGR']
  },
  'recursos del SGR': {
    variable: 'financiacion',
  ...
  'financie con recursos SGR': {
    variable: 'financiacion',
    matches: ['SGR']
  },
  'financie con recursos del SGR': {
    variable: 'financiacion',
    matches: ['SGR']
  },
  'recursos del PGN': {
  ...
  // --- Tipo operador ---
  'se vincule organizaciones de base comunitaria como operadores': {
    variable: 'tipoOperador',
    matches: ['Organización de base comunitaria']
  },
  'organizaciones de base comunitaria como operadores': {
    variable: 'tipoOperador',
    matches: ['Organización de base comunitaria']
  },
...
// Patterns ordenados de más largo a más corto para priorizar matches específicos
const CONDITION_PATTERNS_SORTED = Object.keys(CONDITION_MAPPINGS).sort((a, b) => b.length - a.length);
...
const FILTER_CONFIG = [{
  key: 'zona',
  label: 'Zona',
  options: ['Todas', 'Urbana', 'Rural', 'Rural de difícil acceso']
}, {
  key: 'modalidad',
  label: 'Modalidad',
  options: ['Todas', 'Preparada en sitio', 'Caliente transportada', 'Industrializada', 'Canasta PAE en Casa', 'Bono Alimentario']
}, {
  key: 'tipoETC',
  label: 'Tipo ETC',
  options: ['Todos', 'Departamental', 'Municipal certificada']
}, {
  key: 'nivelEscolar',
  label: 'Nivel escolar',
  options: ['Todos', 'Preescolar / 2do ciclo ed. inicial', 'Primaria', 'Secundaria']
}, {
  key: 'jornada',
  label: 'Jornada',
  options: ['Todas', 'Media jornada', 'Completa (6h)', 'Extendida (8h)', 'Jornada única']
}, {
  key: 'enfoqueDif',
  label: 'Enfoque dif.',
  options: ['Todos', 'Ninguno', 'Indígena', 'NARP']
}, {
  key: 'modeloAtencion',
  label: 'Modelo atención',
  options: ['Todos', 'Convencional', 'Pueblos indígenas', 'Comunidades NARP', 'Rural difícil acceso', 'Residencias escolares']
}, {
  key: 'situacion',
  label: 'Situación',
  options: ['Todas', 'Operación normal', 'Receso estudiantil', 'Emergencia declarada']
}, {
  key: 'financiacion',
  label: 'Financiación',
  options: ['Todas', 'SGP', 'SGR', 'PGN', 'Mixta']
}, {
  key: 'tipoOperador',
  label: 'Tipo operador',
  options: ['Todos', 'Operador convencional', 'Organización de base comunitaria', 'FSE / AMPF']
}];
const DEFAULT_FILTERS = {};
FILTER_CONFIG.forEach(f => {
  DEFAULT_FILTERS[f.key] = f.options[0];
});
...
function getRiskColor(r) {
  return RISK_COLORS[r] || RISK_DEFAULT_COLOR;
}
function getRiskIcon(r) {
  return RISK_ICONS[r] || RISK_DEFAULT_ICON;
}

// Evalúa UNA sola parte atómica (sin AND/OR) contra los filtros
function evaluateSinglePart(partText, filters) {
  const trimmed = partText.trim();
  // Handle placeholders from resolved parentheses
  if (trimmed === '__MATCH__') return 'match';
  if (trimmed === '__NOMATCH__') return 'nomatch';
  if (trimmed === '__UNEVALUABLE__') return 'unevaluable';
  ...
  // Iterate patterns sorted longest-first for priority
  for (const pattern of CONDITION_PATTERNS_SORTED) {
    if (lowerPart.includes(pattern.toLowerCase())) {
      hasMapping = true;
      const mapping = CONDITION_MAPPINGS[pattern];
...
// Resuelve paréntesis recursivamente de dentro hacia fuera
function resolveParentheses(text, filters) {
  let result = text;
  let safety = 20; // prevent infinite loops
  // Keep resolving innermost parentheses until none remain
  while (result.includes('(') && safety-- > 0) {
    // Match the innermost parentheses: content with no parens inside
    const match = result.match(/(?:(?:NOT|no aplica)\s+)?\(([^()]+)\)/i);
    if (!match) break;
    const fullMatch = match[0];
    const innerContent = match[1];
    const hasNot = /^(?:NOT|no aplica)\s+/i.test(fullMatch);

    // Evaluate the inner content as OR parts
    const orParts = innerContent.split(/\s+(?:OR|O)\s+/i);
    const results = orParts.map(p => evaluateSinglePart(p.trim(), filters));

    // OR logic: any match → match, all nomatch → nomatch, else unevaluable
    let resolved;
    if (results.some(r => r === 'match')) resolved = 'match';else if (results.every(r => r === 'nomatch')) resolved = 'nomatch';else resolved = 'unevaluable';

    // Apply NOT inversion
    if (hasNot) {
      if (resolved === 'match') resolved = 'nomatch';else if (resolved === 'nomatch') resolved = 'match';
      // unevaluable stays unevaluable
    }

    // Replace the full match with a placeholder
    const placeholder = resolved === 'match' ? '__MATCH__' : resolved === 'nomatch' ? '__NOMATCH__' : '__UNEVALUABLE__';
    result = result.replace(fullMatch, placeholder);
  }
  return result;
}

// Orquestadora principal: evalúa condición completa con soporte AND/OR/NOT/paréntesis
function evaluateCondition(condText, filters) {
  ...
  // Step 1: Resolve parentheses first
  const resolved = resolveParentheses(condText, filters);

  // Step 2: Determine top-level operator
  const lowerResolved = resolved.toLowerCase();
  const isAnd = lowerResolved.includes(' and ');
  const isOr = lowerResolved.includes(' or ') || lowerResolved.includes(' o ');

  // Step 3: Split by top-level operator
  const parts = isAnd ? resolved.split(/\s+AND\s+/i) : isOr ? resolved.split(/\s+(?:OR|O)\s+/i) : [resolved];

  // Step 4: Evaluate each part
  const results = parts.map(part => evaluateSinglePart(part.trim(), filters));

  // Step 5: All unevaluable → verify
  ...
  // Step 6: Apply AND/OR logic
  if (isAnd) {
    if (results.some(r => r === 'nomatch')) return {
      status: 'noApplica',
      label: condText
    };
    if (results.some(r => r === 'unevaluable')) return {
      status: 'verify',
      label: condText
    };
    return {
  ...
  if (isOr) {
    ...
    if (results.every(r => r === 'nomatch')) return {
      status: 'noApplica',
      label: condText
    };
    return {
...
function buildTree(data) {
  ...
  ETAPA_ORDER.forEach(etapa => {
    ...
    const cats = {};
    etapaLins.forEach(l => {
      if (!cats[l.cat_id]) cats[l.cat_id] = {
        id: l.cat_id,
        nombre: l.cat_nombre,
        subcats: {}
      };
      if (!cats[l.cat_id].subcats[l.subcat_id]) {
        cats[l.cat_id].subcats[l.subcat_id] = {
          id: l.subcat_id,
          nombre: l.subcat_nombre,
          lineamientos: []
        };
      }
    ...
    transversalLins.forEach(l => {
      ...
      if (!catNode.subcats[ghostSubId]) {
        catNode.subcats[ghostSubId] = {
          id: ghostSubId,
          nombre: l.subcat_nombre + ' (Transversal)',
          lineamientos: [],
          isGhost: true
        };
      }
...
function LineamientoDetail({
  lin
}) {
  const docNames = {
    D998: 'Decreto 998 de 2025',
    D1852: 'Decreto 1852 de 2015',
    GG: 'Guía General PAE',
    A1: 'Anexo 1: Diagnóstico',
    A2: 'Anexo 2: Estructuración y Contratación',
    A3: 'Anexo 3: Alimentación Saludable',
    A4: 'Anexo 4: Compras Públicas Locales',
    A5: 'Anexo 5: Calidad e Inocuidad',
    A6: 'Anexo 6: Planeación Financiera',
    A7: 'Anexo 7: Participación Ciudadana',
    A8: 'Anexo 8: Evaluación',
    R0003: 'Resolución 0003 de 2026'
  };
  const actorNames = {
    UAPA: 'UAPA (Unidad Administrativa de Alimentación Escolar)',
    ETC: 'Entidad Territorial Certificada',
    ETHNOC: 'Entidad Territorial No Certificada',
    OPER: 'Operador del PAE',
    INTER: 'Interventoría',
    EQUPAE: 'Equipo PAE',
    ORGCONT: 'Órganos de Control',
    CTPS: 'Comité Territorial de Planeación y Seguimiento'
  };
  ...
  }, "Lineamiento:"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: '#374151'
    }
  }, lin.texto_lineamiento)), lin.condicion_activacion && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 8,
      padding: '6px 10px',
      background: '#EDE9FE',
  ...
  }, "Condici\xF3n:"), ' ', /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#4C1D95'
    }
  }, lin.condicion_activacion)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Obligatoriedad:"), " ", lin.obligatoriedad || 'N/A'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Tipo regla:"), " ", (lin.tipo_regla || '').replace(/_/g, ' ')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Etapa:"), " ", ETAPA_NAMES[lin.etapa_pae] || lin.etapa_pae), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Documento:"), " ", docNames[lin.doc_id] || lin.doc_id), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Actor responsable:"), " ", actorNames[lin.actor_responsable] || lin.actor_responsable), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Actor verificador:"), " ", actorNames[lin.actor_verificador] || lin.actor_verificador)), lin.verificadores.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Verificador(es) (", lin.verificadores.length, ")"), lin.verificadores.map(v => /*#__PURE__*/React.createElement("div", {
    key: v.ver_id,
    style: {
      padding: '8px 10px',
      background: '#fff',
  ...
  }, v.ver_id), /*#__PURE__*/React.createElement("div", {
    style: {
      color: '#4B5563',
      marginBottom: 3
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("em", null, "Tipo:"), " ", v.tipo_verificador), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("em", null, "Instrumento:"), " ", v.instrumento), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("em", null, "Frecuencia:"), " ", v.frecuencia)), v.criterio_cumple && /*#__PURE__*/React.createElement("div", {
    style: {
      color: '#065F46',
      marginTop: 4,
      fontSize: 11
    }
  }, /*#__PURE__*/React.createElement("em", null, "Criterio:"), " ", v.criterio_cumple)))));
}

// --- Lineamiento Node (Leaf) ---
function LineamientoNode({
  lin,
  evaluation,
  isHidden,
  isGrey
  ...
  }, getRiskIcon(risk)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 500,
      color: '#374151',
  ...
  }, lin.lin_id), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#9CA3AF',
      fontSize: 10,
      flexShrink: 0
  ...
  }, lin.obligatoriedad || 'N/A'), /*#__PURE__*/React.createElement(RiskBadge, {
    risk: risk
  }), /*#__PURE__*/React.createElement(ConditionBadge, {
    evaluation: evaluation
  }), lin.isGhost && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      padding: '1px 5px',
      borderRadius: 8,
  ...
  }, "fantasma"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1,
      fontSize: 11,
      color: '#9CA3AF',
  ...
  }, lin.texto_lineamiento ? lin.texto_lineamiento.substring(0, 80) + '...' : '')), expanded && /*#__PURE__*/React.createElement(LineamientoDetail, {
    lin: lin
  }));
}
...
function SubcategoryNode({
  ...
  const evaluated = useMemo(() => {
    return subcat.lineamientos.map(l => {
      ...
      const isHidden = uapaOnly && l.actor_verificador !== 'UAPA' || showOnlyApplicable && ev.status === 'noApplica';
      const isGrey = !uapaOnly && l.actor_verificador !== 'UAPA';
      const matchesSearch = !search || l.lin_id.toLowerCase().includes(search) || (l.texto_lineamiento || '').toLowerCase().includes(search) || l.subcat_id.toLowerCase().includes(search);
      return {
        lin: l,
        evaluation: ev,
        isHidden: isHidden || search && !matchesSearch,
        isGrey
      };
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, open ? '▼' : '▶'), /*#__PURE__*/React.createElement("span", null, subcat.nombre), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: '#9CA3AF',
      fontWeight: 400
    }
  }, "(", visibleCount, " lin. | ", uapaCount, " UAPA", condCount > 0 ? ` | ${condCount} cond.` : '', ")")), open && /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: 4
    }
  }, evaluated.map(({
    ...
    isHidden,
    isGrey
  }) => /*#__PURE__*/React.createElement(LineamientoNode, {
...
function CategoryNode({
  ...
  const visibleLins = useMemo(() => {
    return allLins.filter(l => {
      ...
      if (search) {
        ...
        if (!l.lin_id.toLowerCase().includes(s) && !(l.texto_lineamiento || '').toLowerCase().includes(s) && !l.subcat_id.toLowerCase().includes(s)) return false;
      }
      return true;
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: 24,
      borderLeft: `1px solid ${etapaColor}30`,
      paddingLeft: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
    onClick: () => setOpen(!open),
  ...
  }), /*#__PURE__*/React.createElement("span", null, catData.nombre), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      color: '#9CA3AF',
      fontWeight: 400
    }
  }, "(", visibleLins.length, " lin. | ", uapaCount, " UAPA", condCount > 0 ? ` | ${condCount} cond.` : '', ")")), open && Object.entries(catData.subcats).sort(([, a], [, b]) => (a.isGhost ? 1 : 0) - (b.isGhost ? 1 : 0)).map(([scId, sc]) => /*#__PURE__*/React.createElement(SubcategoryNode, {
    key: scId,
    subcat: sc,
    filters: filters,
    uapaOnly: uapaOnly,
...
function EtapaNode({
  ...
  }, open ? '▼' : '▶'), /*#__PURE__*/React.createElement("span", null, ETAPA_NAMES[etapa]), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: '#6B7280',
      fontWeight: 500
    }
  }, "(", visibleLins.length, " lineamientos | ", uapaCount, " UAPA | ", condCount, " condicionales)")), open && Object.entries(cats).sort(([a], [b]) => a.localeCompare(b)).map(([catId, catData]) => /*#__PURE__*/React.createElement(CategoryNode, {
    key: catId,
    catId: catId,
    catData: catData,
    etapa: etapa,
...
// --- Filter Incompatibility Rules ---
const FILTER_INCOMPATIBILITIES = [{
  id: 'rural_dificil_vs_indigena',
  check: f => f.zona === 'Rural de difícil acceso' && f.enfoqueDif === 'Indígena',
  message: 'El modelo rural difícil acceso solo aplica en sedes que NO cumplan criterios del modelo indígena. Si la sede es indígena, aplica el modelo PAE para pueblos indígenas.',
  severity: 'warning',
  ref: 'R0003-ALI-DIF-003'
}, {
  id: 'rural_dificil_vs_narp',
  check: f => f.zona === 'Rural de difícil acceso' && f.enfoqueDif === 'NARP',
  message: 'El modelo rural difícil acceso solo aplica en sedes que NO cumplan criterios del modelo NARP. Si la sede es NARP, aplica el modelo PAE para comunidades NARP.',
  severity: 'warning',
  ref: 'R0003-ALI-DIF-003'
}, {
  id: 'modelo_vs_enfoque_indigena',
  check: f => f.modeloAtencion === 'Pueblos indígenas' && f.enfoqueDif !== 'Todos' && f.enfoqueDif !== 'Indígena',
  message: 'El modelo de pueblos indígenas requiere que el enfoque diferencial sea Indígena.',
  severity: 'error',
  ref: 'R0003-ALI-DIF-001'
}, {
  id: 'modelo_vs_enfoque_narp',
  check: f => f.modeloAtencion === 'Comunidades NARP' && f.enfoqueDif !== 'Todos' && f.enfoqueDif !== 'NARP',
  message: 'El modelo de comunidades NARP requiere que el enfoque diferencial sea NARP.',
  severity: 'error',
  ref: 'R0003-ALI-DIF-001'
}, {
  id: 'preescolar_industrializada',
  check: f => f.nivelEscolar === 'Preescolar / 2do ciclo ed. inicial' && (f.jornada === 'Completa (6h)' || f.jornada === 'Extendida (8h)') && f.modalidad === 'Industrializada',
  message: 'Para preescolar con jornadas de 6h u 8h, las únicas modalidades permitidas son Preparada en sitio y Caliente transportada.',
  severity: 'error',
  ref: 'R0003-ALI-DIF-004'
}, {
  id: 'rural_dificil_industrializada',
  check: f => f.zona === 'Rural de difícil acceso' && f.modalidad === 'Industrializada',
  message: 'En zonas rurales de difícil acceso las únicas modalidades permitidas son Preparada en sitio y Caliente transportada.',
  severity: 'error',
  ref: 'R0003-ALI-DIF-004'
}, {
  id: 'residencias_no_almuerzo',
  check: f => f.modeloAtencion === 'Residencias escolares' && f.modalidad !== 'Todas' && f.modalidad !== 'Preparada en sitio' && f.modalidad !== 'Caliente transportada',
  message: 'En residencias escolares se debe garantizar el 100% RIEN; las modalidades Industrializada, Canasta o Bono no son adecuadas para este modelo.',
  severity: 'warning',
  ref: 'R0003-ALI-DIF-002'
}, {
  id: 'canasta_sin_emergencia_ni_receso',
  check: f => f.modalidad === 'Canasta PAE en Casa' && f.situacion !== 'Todas' && f.situacion !== 'Receso estudiantil' && f.situacion !== 'Emergencia declarada',
  message: 'La modalidad Canasta PAE en Casa solo se autoriza durante receso estudiantil o emergencia declarada.',
  severity: 'error',
  ref: 'R0003-ALI-EME'
}, {
  id: 'bono_sin_emergencia',
  check: f => f.modalidad === 'Bono Alimentario' && f.situacion !== 'Todas' && f.situacion !== 'Emergencia declarada',
  message: 'La modalidad Bono Alimentario solo se autoriza ante emergencia declarada que afecte la prestación por más de 10 días.',
  severity: 'error',
  ref: 'R0003-ALI-EME-003'
}];
function checkFilterIncompatibilities(filters) {
  return FILTER_INCOMPATIBILITIES.filter(rule => rule.check(filters));
}
function FilterIncompatibilityWarnings({
  filters
}) {
  const warnings = useMemo(() => checkFilterIncompatibilities(filters), [filters]);
  ...
  }, warnings.map(w => /*#__PURE__*/React.createElement("div", {
    key: w.id,
    style: {
      padding: '10px 14px',
      borderRadius: 8,
      ...
      gap: 8,
      background: w.severity === 'error' ? '#FEE2E2' : '#FEF3C7',
      border: `1px solid ${w.severity === 'error' ? '#FECACA' : '#FDE68A'}`,
  ...
  }, w.severity === 'error' ? '🚫' : '⚠️'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      marginBottom: 2
    }
  }, w.severity === 'error' ? 'Combinación no permitida' : 'Advertencia de compatibilidad'), /*#__PURE__*/React.createElement("div", null, w.message), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      marginTop: 4,
      opacity: 0.7
...
function StatsPanel({
  ...
  const stats = useMemo(() => {
    ...
    if (search) {
      const s = search.toLowerCase();
      visible = visible.filter(l => l.lin_id.toLowerCase().includes(s) || (l.texto_lineamiento || '').toLowerCase().includes(s) || l.subcat_id.toLowerCase().includes(s));
    }
    ...
    return {
      ...
      byEtapa,
      conditional,
      universal: visible.length - conditional
    };
  ...
  }, open ? '▼' : '▶'), "Resumen estad\xEDstico", /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 400,
      color: '#9CA3AF'
    }
  }, "\u2014 ", stats.visible, " de ", stats.total, " lineamientos visibles")), open && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 14px 14px',
      display: 'grid',
  ...
  }, "Por riesgo"), ['critico', 'alto', 'medio', 'bajo'].map(r => /*#__PURE__*/React.createElement("div", {
    key: r,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, r, " (", stats.byRisk[r] || 0, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      height: 10,
      background: '#E5E7EB',
  ...
  }, "Sin dato: ", stats.byRisk[''] || 0)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      fontWeight: 600,
      color: '#6B7280',
  ...
  }, "Por etapa"), ETAPA_ORDER.map(e => /*#__PURE__*/React.createElement("div", {
    key: e,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, ETAPA_NAMES[e]), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#6B7280'
    }
  }, stats.byEtapa[e] || 0)))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      fontWeight: 600,
      color: '#6B7280',
  ...
  }, /*#__PURE__*/React.createElement("strong", null, stats.universal), " universales"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: '#6D28D9',
      marginBottom: 4
    }
  }, /*#__PURE__*/React.createElement("strong", null, stats.conditional), " condicionales"))));
}
...
export default function ArbolDecisionesPAE() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\xC1rbol de Lineamientos PAE \u2014 Inspecci\xF3n UAPA"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 14,
      color: '#6B7280',
      margin: 0
    }
  }, "Navegador de decisiones condicionales del Programa de Alimentaci\xF3n Escolar"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: '#9CA3AF',
      margin: '4px 0 0'
    }
  }, "\xDAltima actualizaci\xF3n del banco: Febrero 2026 \xB7 ", DATA.lineamientos.length, " lineamientos \xB7 ", DATA.verificadores.length, " verificadores")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 16,
    ...
    type: "checkbox",
    checked: uapaOnly,
    onChange: e => setUapaOnly(e.target.checked),
    style: {
      accentColor: '#16A34A'
    }
  }), "Mostrar solo lineamientos UAPA"), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("button", {
    onClick: () => setExpandAll(p => p + 1),
    style: {
      padding: '4px 10px',
      fontSize: 11,
      background: '#fff',
  ...
  }, "Expandir todo"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setCollapseAll(p => p + 1),
    style: {
      padding: '4px 10px',
      fontSize: 11,
      background: '#fff',
  ...
  }, "Colapsar todo")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px 16px',
      background: '#F3F4F6',
      border: '1px solid #E5E7EB',
  ...
  }, "Configuraci\xF3n del territorio / operaci\xF3n"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(5, 1fr)',
      gap: '8px 12px'
    }
  }, FILTER_CONFIG.map(f => /*#__PURE__*/React.createElement("div", {
    key: f.key
  }, /*#__PURE__*/React.createElement("label", {
    style: {
      fontSize: 11,
  ...
  }, "Limpiar filtros"), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 5,
  ...
  }), "Mostrar solo lineamientos aplicables"))), /*#__PURE__*/React.createElement(FilterIncompatibilityWarnings, {
    filters: filters
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 16
    ...
    type: "text",
    placeholder: "Buscar por ID, texto o subcategor\xEDa...",
    value: search,
  ...
  }, "\uD83C\uDFEB Sistema PAE"), ETAPA_ORDER.map(etapa => /*#__PURE__*/React.createElement(EtapaNode, {
    key: etapa,
    etapa: etapa,
    cats: tree[etapa] || {},
    filters: filters,
