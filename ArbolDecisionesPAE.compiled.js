...
const FILTER_CONFIG = [{
  ...
  key: 'modalidad',
  label: 'Modalidad',
  options: ['Todas', 'Preparada en sitio', 'Caliente transportada', 'Industrializada']
}, {
  key: 'tipoETC',
  label: 'Tipo ETC',
...
function evaluateCondition(condText, filters) {
  ...
  const parts = isAnd ? condText.split(/\s+AND\s+/i) : isOr ? condText.split(/\s+(?:OR|O)\s+/i) : [condText];
...
export default function ArbolDecisionesPAE() {
  ...
  }), "Mostrar solo lineamientos aplicables"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 16
    }
  }, /*#__PURE__*/React.createElement("input", {
